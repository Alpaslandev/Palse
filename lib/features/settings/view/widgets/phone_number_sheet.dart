...
import 'package:palseapp/core/provider/auth_provider.dart' as app_provider;
...
class _PhoneNumberSheetState extends State<PhoneNumberSheet> {
  ...
  // Kimlik bilgileriyle giriş yapma
  Future<void> _signInWithCredential(PhoneAuthCredential credential) async {
    try {
      // Mevcut kullanıcıya telefon numarasını bağla
      ...
      if (currentUser != null) {
        ...
        if (context.mounted) {
          // Başarılı olduğunda sayfayı kapat ve sonucu döndür

...
class LeaderBoard extends StatelessWidget {
            ...
            return Padding(
              ...
              child: Column(
                children: [
                  ...
                  if (isMe) _buildMe(leaderBoard.indexOf(leaderBoard.firstWhere((element) => element.userId == user.firebaseUser?.uid)), user),
                ],
              ),
            );
          }
  ...
  Widget _buildMe(int index, AuthProvider user) {
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Text('Sizin Sıralamanız: ${index + 1}.', style: TextStyle(color: Colors.white)),

...
const Map<String, String> en = {
  ...
  'profile_setup_error_name': 'Please enter your name and surname correctly (at least 3 characters)',
  'profile_setup_error_birthday_gender': 'Please select your birth date and gender',
  'profile_setup_error_location': 'Please select a location or use your current location',
  'profile_setup_error_nickname': 'Please enter a valid nickname (at least 3 characters)',
  ...
  'user_info_hello': 'Hello {firstName}, you can now proceed to the next steps.',
  'user_info_info': 'Info',
  'user_info_please_enter': 'Please enter your name. This information will appear on your profile.',
  ...
  'birthday_gender_age_restriction': 'You must be at least 18 years old to use this app',
  ...
  'birthday_gender_optional_info': 'Date of birth and gender information are optional. You can update them later in profile settings if you wish.',
  ...
  'birthday_gender_basics_completed': 'Your basic information is complete, now you can proceed to the next steps.',
  'birthday_gender_info': 'Information',
  'birthday_gender_info_text': 'Your birth date and gender will be used to recommend suitable events for you.',
  ...
  'location_permission_text': 'Allow location permission to find events near you',
  'location_permission_button': 'Grant Location Permission',
  'location_required': 'Required',
  'location_optional': 'Optional',
  'location_optional_info': 'Location information is optional. You can update it later in profile settings if you wish.',
  ...
  'profile_picture_add_photo': 'Would you like to add a photo to help us recognize you?',
  'profile_picture_tip': 'Users with profile pictures get 70% more interactions!',
  'profile_picture_add': 'Add Photo',
  'profile_picture_looks_great': 'Looks great! You can tap again if you want to change your photo.',
  'profile_picture_skip_info': 'You can skip this step and add a photo later in profile settings',

  // Step 6: Categories
  'categories_title': 'Select Your Interests',
  'categories_description': 'Select at least 3 categories you\'re interested in',
  ...
  'home_following_empty_message': 'Posts from people you follow will appear here',
  ...
  'match_feature_smart': 'Smart Matching',
  'match_feature_smart_desc': 'AI-based algorithm finds the most suitable people based on interests',
  'match_feature_local': 'Local Connections',
  'match_feature_local_desc': 'Match with people near you',
  'match_feature_safe': 'Safe Environment',
  'match_feature_safe_desc': 'Safe matching with verified users',
  'match_premium_benefit': 'Premium Advantage',
  ...
  'city_events_try_different': 'Select a different category to discover new events',
  ...
  'user_blocked_message': 'You have blocked this user. You need to unblock them to send messages.',
  'listings': 'Listings',
  ...
  'delete_story_confirmation': 'Your story will be permanently deleted. This action cannot be undone. Are you sure?',
  ...
  'sending': 'Sending...',
  'info': 'Information',
  'sms_delay_info': 'The SMS code may take a moment to arrive. Please wait at least 2 minutes.',
  'check_number_retry': 'If you don\'t receive the code, check your number and try again.',
  ...
  'important': 'Important',
  'verification_in_progress': 'Please don\'t leave the app while verification is in progress.',
  'resend_code_info': 'If you didn\'t receive the code, you can click "Resend Code".',
  ...
  'invalid_characters': 'Contains invalid characters (use only numbers, + and spaces)',
  'phone_too_short': 'Phone number is too short',
  'verification_in_progress_enter_code': 'Verification in progress. Please enter the code or complete the process.',

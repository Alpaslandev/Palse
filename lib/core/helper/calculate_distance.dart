...
int calculateDistance({required double latitude1, required double longitude1, required double latitude2, required double longitude2}) {
  ...
  return distance; // Direkt olarak km cinsinden sonuç
}
